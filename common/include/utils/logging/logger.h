...
public:
    ...
    static void Log(int32_t level, string time, string fileName, uint32_t lineNumber, string functionName, string formatString, ...);
    static void LogProd(int32_t level, string time, string fileName, uint32_t lineNumber, string functionName, Variant &le);
