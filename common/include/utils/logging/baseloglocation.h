...
public:
    ...
    virtual bool EvalLogLevel(int32_t level, string time, string &fileName, uint32_t lineNumber,
                              string &functionName, string &message);
    virtual bool EvalLogLevel(int32_t level, string time, string fileName, uint32_t lineNumber,
                              string functionName, Variant &le);
    virtual bool Init();
    virtual void Log(int32_t level, string time, string fileName, uint32_t lineNumber,
